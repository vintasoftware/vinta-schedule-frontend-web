...
const meta = {
  title: 'Components/Bookings/EditEventDialog',
...
/** Non-recurring event — edit form, no scope prompt (direct edit on submit). */
...
/** Recurring event — the ScopePromptDialog appears after the form is submitted. */
