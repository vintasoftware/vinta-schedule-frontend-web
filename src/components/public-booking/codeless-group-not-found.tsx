...
/**
 * CodelessGroupNotFound — the `404` state for an unknown `public_booking_slug`.
 *
 * DISTINCT from `<CodelessGroupUnavailable />` on purpose — see
 * `@/lib/booking-links/codeless-group-read-errors`'s doc comment. An unknown
...
export function CodelessGroupNotFound() {
  return (
    <Card data-testid='codeless-group-not-found'>
      <CardHeader>
