...
/**
 * CodelessGroupUnavailable — the `403` state for a `public_booking_slug`
 * that resolves to a real group this route just isn't open to: private
 ...
 *
 * DISTINCT from `<CodelessGroupNotFound />` on purpose — see
 * `@/lib/booking-links/codeless-group-read-errors`'s doc comment. Never
...
export function CodelessGroupUnavailable() {
  return (
    <Card data-testid='codeless-group-unavailable'>
      <CardHeader>
      ...
      <CardContent>
        <Text color='muted-foreground'>
          This group isn&apos;t currently accepting public bookings. Contact
          whoever shared this link with you for another way to schedule.
        </Text>
      </CardContent>
    </Card>
  );
