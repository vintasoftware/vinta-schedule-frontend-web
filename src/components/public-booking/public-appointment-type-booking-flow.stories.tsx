...
// This story covers the flow's whole-appointment-type proposal READ states, the same
...
// colocated `public-appointment-type-booking-flow.test.tsx`.
...
const meta = {
  title: 'Components/PublicBooking/PublicAppointmentTypeBookingFlow',
  component: PublicAppointmentTypeBookingFlow,
  tags: ['autodocs'],
  args: {
...
} satisfies Meta<typeof PublicAppointmentTypeBookingFlow>;
