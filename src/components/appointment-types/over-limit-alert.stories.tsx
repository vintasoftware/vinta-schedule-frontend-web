...
// No AppointmentTypePermissionsProvider wrapper -- this component reads no
// permission context (same precedent as appointment-type-not-found.stories.tsx).
const meta = {
  title: 'Components/AppointmentTypes/OverLimitAlert',
