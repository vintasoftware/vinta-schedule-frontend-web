...
import { appointmentTypesSlotsBlockedTimesListOptions } from '@/client/@tanstack/react-query.gen';
...
function makeSeededQueryClient(blocks: AppointmentTypeScopedBlockedTime[]) {
...
const meta = {
  title: 'Components/AppointmentTypes/AppointmentTypeBlockList',
  component: AppointmentTypeBlockList,
  tags: ['autodocs'],
} satisfies Meta<typeof AppointmentTypeBlockList>;
