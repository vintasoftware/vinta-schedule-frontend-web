 ...
 * appointment-type-scoped configuration". Kept pure and framework-free (no 'use
 * client', no React import) so it stays importable from a Server Component
 * too, and is directly unit-tested (appointment-type-permissions.test.ts) rather than
 ...
 * tree live in appointment-type-permissions-provider.tsx ('use client' — creates a
 ...
 * ai-plans/2026-08-05-CALENDAR_APPOINTMENT_TYPE_SCOPED_AVAILABILITY_IMPLEMENTATION_PLAN.md.
 ...
 * appointment-type-scoped configuration. Everyone else may edit only calendars they own.
