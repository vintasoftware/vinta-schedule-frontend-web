...
// GroupBlockForm calls useGroupScopedBlocks with `enabled: false` (it only
...
const EXISTING_BLOCK: GroupScopedBlockedTime = {
  id: 501,
  calendar_id: 100,
  group_slot_id: 10,
...
const meta = {
  title: 'Components/CalendarGroups/GroupBlockForm',
  component: GroupBlockForm,
  tags: ['autodocs'],
  decorators: [
    (Story) => (
...
} satisfies Meta<typeof GroupBlockForm>;
