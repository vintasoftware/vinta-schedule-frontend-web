...
// No GroupPermissionsProvider wrapper -- unlike most calendar-groups
// stories, this component reads no permission context (same precedent as
// group-not-found.stories.tsx, the other permission-agnostic component in
// this feature).
const meta = {
  title: 'Components/CalendarGroups/OrphanedBookingsAlert',
...
// to gate on `bookings.length > 0` (see group-window-grid.tsx), but the
