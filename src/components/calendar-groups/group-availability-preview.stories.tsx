...
import { GROUP_SCOPED_WINDOWS_PAGE_SIZE } from '@/hooks/calendar-groups/use-group-scoped-windows';
import type {
...
// `use-group-availability-preview.ts`'s module doc comment). There is no
...
function makeSeededQueryClient(
  windows: GroupScopedAvailabilityWindow[],
  availabilityResults: CalendarGroupRangeAvailability[]
): QueryClient {
...
// five days have no group-scoped window at all in this slot, so they render
...
// A calendar with NO group-scoped window at all for this slot -- there is
