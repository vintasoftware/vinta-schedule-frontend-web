/**
 * useAppointmentTypeScopedConfigSummary — per-calendar counts of appointment-type-scoped
 ...
 * with more appointment-type-scoped rows than the page size undercounts rather than
...
// Large enough to cover any realistic slot roster's appointment-type-scoped rows in one
...
export function useAppointmentTypeScopedConfigSummary({
  appointmentTypeId,
  slotId,
}: {
