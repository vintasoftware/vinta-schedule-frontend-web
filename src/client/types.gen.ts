 ...
 * * `bundle` - Bundle Calendar
 */
export type CalendarTypeEnumWritable = 'personal' | 'resource' | 'virtual' | 'bundle';
 ...
 * * `calendar_event_attendee_updated` - Calendar Event Attendee Updated
 */
export type EventTypeEnumWritable = 'calendar_event_created' | 'calendar_event_updated' | 'calendar_event_deleted' | 'calendar_event_attendee_added' | 'calendar_event_attendee_removed' | 'calendar_event_attendee_updated';
 ...
 * * `ics` - ICS
 */
export type ProviderEnumWritable = 'internal' | 'google' | 'microsoft' | 'apple' | 'ics';
 ...
 * * `pending` - Pending
 */
export type RsvpStatusEnumWritable = 'accepted' | 'declined' | 'pending';
 ...
 * * `failed` - Failed
 */
export type WebhookEventStatusEnumWritable = 'pending' | 'success' | 'failed';
...
export type WebhookConfigurationsPartialUpdateData = {
    body?: PatchedWebhookConfiguration;
    path: {
        id: string;
    };
    query?: never;
