/**
 * BrandedBookReschedulePage is an async Server Component — render the
 * awaited element directly, same pattern as the branded book page test.
 */
...
import BrandedBookReschedulePage, { metadata } from './page';

describe('BrandedBookReschedulePage (/o/[slug]/book/[code]/reschedule)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('fetches branding by slug and passes it to the shell', async () => {
    ...
    render(
      await BrandedBookReschedulePage({
