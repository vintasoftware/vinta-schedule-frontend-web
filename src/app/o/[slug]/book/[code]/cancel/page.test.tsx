/**
 * BrandedBookCancelPage is an async Server Component — render the awaited
 * element directly, same pattern as the branded book page test.
 */
...
import BrandedBookCancelPage, { metadata } from './page';

describe('BrandedBookCancelPage (/o/[slug]/book/[code]/cancel)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
