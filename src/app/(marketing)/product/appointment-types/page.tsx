...
const steps = [
  ...
  },
  {
    n: '02',
    icon: UsersRound,
    title: 'Define the appointment type',
  ...
  },
  {
    ...
    icon: CalendarCheck,
    title: 'Take bookings',
    body: 'Query the appointment type for live availability. Vinta picks a valid combination and writes the event back to every calendar.',
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        lead='An Appointment Type bundles the people, rooms, and equipment that can fulfill a given kind of visit. Patients reach one link; Vinta resolves who and what is actually free.'
        primary={{ label: 'Start building', href: '/auth/signup' }}
        secondary={{
          label: 'Concept guide',
          href: '/docs/concepts/appointment-types',
          icon: Layers,
        }}
      />
      ...
      <MarketingSection>
        <SectionIntro
          ...
          lead='Stop asking patients to pick a person. Describe the service once, and let the appointment type figure out every valid combination.'
        />
      ...
      <CtaBand
        ...
        lead='Model your services as Appointment Types and let Vinta handle the matching.'
        primary={{ label: 'Start building', href: '/auth/signup' }}
        secondary={{
