        ...
        <Stack gap={4}>
          <Stack gap={4}>
            ...
            <Text color='muted-foreground'>
              ...
              HTTP POST. Events are delivered at least once: failed deliveries
              are retried automatically (up to 5 attempts, with exponential
              backoff) and ordering is not guaranteed, so a retry can arrive
              after the first attempt at a later event. Dedupe using the id
              field on the payload envelope, which stays the same across the
              original delivery and every retry of it.
            </Text>
          ...
          <Box borderTop pt={6}>
            <Stack gap={4}>
              ...
              <Text color='muted-foreground'>
                Use the GraphQL API to manage webhook subscriptions. See the
              ...
              <List variant='bullet' gap={2}>
                <ListItem>
                  ...
                  — Represents a webhook endpoint configuration and its
                  subscribed events.
                </ListItem>
                <ListItem>
                  <TextLink asChild>
